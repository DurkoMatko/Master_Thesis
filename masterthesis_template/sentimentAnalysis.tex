...
\section{History}
\input{sentimentAnalysisHistory}

\section{Training datasets}
\input{trainingDatasets}

\section{Language processing tools}
\input{languageProcessingTools}

\section{Performance metrics}
\input{confusionMatrices}

\section{Classifier evaluation}
\input{classifierEvaluation}

\section{Data to analyze}
\input{dataForSentimentAnalysis}

\section{Results}
\input{resultsBeforeAfter}
