...
\begin{figure}[H]%
    \centering
    \subfloat[EmberJS]{{\includegraphics[width=6cm]{EmberReleasesSentiment.jpg} }}%
    \qquad
    \subfloat[Laravel]{{\includegraphics[width=6cm]{LaravelReleasesSentiment.jpg} }}%
...
\begin{figure}[H]%
    \centering
    \subfloat[NodeJS]
    {{\includegraphics[width=6cm]{NodeReleasesSentiment.jpg} }}%
    \qquad
    \subfloat[VueJS]{{\includegraphics[width=6cm]{VueReleasesSentiment.jpg} }}%
...
\begin{figure}[H]%
    \centering
    \subfloat[CakePhp]{{\includegraphics[width=6cm]{CakeReleasesSentiment.jpg} }}%
    \qquad
    \subfloat[AngularJS]{{\includegraphics[width=6cm]{AngularReleasesSentiment.jpg} }}%
